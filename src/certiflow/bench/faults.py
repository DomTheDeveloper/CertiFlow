...
MUTATORS:dict[str,Callable[[IRNode],IRNode]]={"join_key":mutate_join_key,"group_grain":mutate_group_grain,"projection":mutate_projection,"schema":mutate_schema,"restricted_flow":mutate_restricted_flow}
